...
endforeach;
	...
	if ($this->request->is(array('post', 'put'))) {//ES UN POST
		...
		if($this->Transporte->save($this->request->data)){
		    //$this->Flash->set('L�nea de transporte guardada');
//		    $this->Flash->success(
//                'L�nea de transporte guardada',
//                array(
//                    'params' => array(
...
//                )
//            );
		    $this->Flash->message('L�nea de transporte guardada');
		    $this->redirect(array(
			'controller' => 'operaciones',
			'action' => 'view_trafico',
			$operacion_id
		    ...
		    $this->Flash->set('L�nea de transporte NO guardada');
		}
	    }else{
		if($this->Transporte->save($this->request->data)){
		    $this->Flash->set('L�nea de transporte modificada');
		    $this->redirect(array(
	...
	if ($this->Transporte->delete($id)):
	    $this->Flash->set('L�nea de transporte borrada');
		$this->History->back(-1);
	/*  $this->redirect(array(
		    'controller' => 'operaciones',
		    'action' => 'view_trafico',
