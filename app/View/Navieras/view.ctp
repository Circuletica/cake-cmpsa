...
if (empty($empresa)):
	...
	echo $this->Button->edit('navieras',$empresa['Naviera']['id'])
		.' '.$this->Button->delete('navieras',$empresa['Naviera']['id'],$empresa['Empresa']['nombre_corto']);
	echo "</div>";
?>
...
?>
	...
	<div class="btabla">
<?php
	echo $this->Button->addLine('contactos','navieras',$empresa['Empresa']['id'],'contacto');
?>
	</div>
</div>
