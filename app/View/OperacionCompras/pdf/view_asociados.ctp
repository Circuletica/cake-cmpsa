...
echo "<h3 style='text-align: center;'>FICHA DE COMPRA ".$operacion['OperacionCompra']['referencia'].'</h3>';
echo "<hr><br><br>";
...
//echo "  <dd>Asegurado a ".$operacion['OperacionCompra']['cambio_dolar_euro'].'$/€ &nbsp;'."</dd>";
echo "  <dt>Precio €/Tm:</dt>\n";
