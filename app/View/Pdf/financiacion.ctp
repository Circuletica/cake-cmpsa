...
$this->start('main');
echo "<h3 style='text-align: center;'>DEPARTAMENTO DE CONTABILIDAD</h3>";
echo "<h3 style='text-align: center;'>FINANCIACIÓN DE LA OPERACIÓN ".$financiacion['Operacion']['referencia'].'</h3>';
echo "<hr><br>";
