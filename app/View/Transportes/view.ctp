...
echo "  <dt>Contrato</dt>\n";
echo "<dd>";
echo $this->Html->link($transporte['OperacionCompra']['Contrato']['referencia'], array(
    'controller' => 'contratos',
    'action' => 'view',
    $transporte['OperacionCompra']['Contrato']['id'])
);
echo "</dd>";
...
echo "</dd>";
if($transporte['OperacionCompra']['Contrato']['Incoterm']['nombre'] !='IN STORE DESPACHADO' && $transporte['OperacionCompra']['Contrato']['Incoterm']['nombre'] !='IN STORE'){
...
if ($transporte['Transporte']['fecha_llegada'] !=NULL && $transporte['OperacionCompra']['Contrato']['Incoterm']['nombre'] =='CIF'){
...
}elseif($transporte['OperacionCompra']['Contrato']['Incoterm']['nombre']=='CIF'){
...
if ($transporte['OperacionCompra']['Contrato']['Incoterm']['nombre'] !='FOB'){
