...
--
-- Table structure for table `asociado_linea_contratos`
--

DROP TABLE IF EXISTS `asociado_linea_contratos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `asociado_linea_contratos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_asociado_linea_contratos_linea_contratos1` FOREIGN KEY (`linea_contrato_id`) REFERENCES `linea_contratos` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `asociado_linea_contratos`
--

LOCK TABLES `asociado_linea_contratos` WRITE;
/*!40000 ALTER TABLE `asociado_linea_contratos` DISABLE KEYS */;
INSERT INTO `asociado_linea_contratos` VALUES (1,12,68,10,'2015-07-17 21:27:27','2015-07-17 21:27:27'),(2,12,75,20,'2015-07-17 21:27:27','2015-07-17 21:27:27'),(3,12,76,30,'2015-07-17 21:27:27','2015-07-17 21:27:27'),(16,15,76,10,'2015-07-20 23:56:12','2015-07-20 23:56:12'),(17,15,77,10,'2015-07-20 23:56:12','2015-07-20 23:56:12'),(18,15,78,10,'2015-07-20 23:56:13','2015-07-20 23:56:13'),(25,19,80,800,'2015-07-21 20:23:32','2015-07-21 20:23:32'),(26,20,82,20,'2015-07-21 21:22:35','2015-07-21 21:22:35');
/*!40000 ALTER TABLE `asociado_linea_contratos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `canal_compras` (
  ...
  `precio_fijo` tinyint(1) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `canal_compras` VALUES (1,'Londres','$/Tm',0,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,'New-York','¢/Lb',0,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(3,'Precio fijo (€/Tm)','€/Tm',1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(4,'Precio fijo (¢/Lb)','¢/Lb',1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(5,'Precio fijo ($/Tm)','$/Tm',1,'2015-07-21 14:40:12','2015-07-21 14:40:12');
...
INSERT INTO `contrato_embalajes` VALUES (26,21,2,13,1000,'2015-07-07 13:11:16','2015-07-07 13:11:16'),(27,21,1,200,60,'2015-07-07 13:11:16','2015-07-07 13:11:16'),(28,21,5,100,69,'2015-07-07 13:11:16','2015-07-07 13:11:16'),(48,27,2,40,1000,'2015-07-14 17:09:39','2015-07-14 17:09:39'),(49,27,1,1000,60,'2015-07-14 17:09:39','2015-07-14 17:09:39'),(54,35,1,4000,60,'2015-07-21 14:42:27','2015-07-21 14:42:27'),(55,22,2,60,1000,'2015-07-21 20:07:24','2015-07-21 20:07:24'),(56,22,1,1000,60,'2015-07-21 20:07:24','2015-07-21 20:07:24'),(57,31,1,2240,60,'2015-07-21 20:19:07','2015-07-21 20:19:07');
...
INSERT INTO `contratos` VALUES (5,46,3,12,2,'069/069',1.36,NULL,NULL,NULL,'2015-09-11','2015-11-20','2015-06-11 17:55:42','2015-06-11 17:55:42'),(6,43,5,24,1,'1507/01',260.00,NULL,NULL,3.15,'2015-10-05','2015-12-17','2015-07-05 01:43:13','2015-07-05 01:43:13'),(7,44,3,8,2,'333/22/11',111.00,NULL,NULL,56.00,'2015-07-06','2015-07-06','2015-07-06 01:30:14','2015-07-06 01:30:14'),(12,47,4,23,2,'44/55/666',123.00,NULL,NULL,2.56,'2015-07-06','2015-07-06','2015-07-06 02:00:05','2015-07-06 02:00:05'),(17,41,1,26,1,'11/22/33/44/55',123.00,NULL,NULL,456.00,'2015-07-06','2016-03-06','2015-07-06 22:32:09','2015-07-06 22:32:09'),(21,41,2,12,1,'11/22/33/44/5678',234.00,NULL,NULL,567.00,'2015-07-06','2016-07-06','2015-07-07 13:11:15','2015-07-06 22:45:13'),(22,38,2,8,1,'CO123456',-18.00,120000,120,5.00,'2015-08-01','2015-10-07','2015-07-21 20:07:24','2015-07-07 14:10:39'),(27,45,3,25,1,'123456789',15.00,100000,NULL,5.00,'2015-07-01','2015-07-01','2015-07-14 17:09:39','2015-07-14 16:39:21'),(31,38,1,12,1,'CO-7096202',265.00,134400,14,NULL,'2015-07-01','2015-03-01','2015-07-21 20:19:07','2015-07-21 14:04:18'),(35,39,4,8,5,'glloq',150.00,240000,NULL,NULL,NULL,'2015-03-01','2015-07-21 14:42:27','2015-07-21 14:42:27');
...
INSERT INTO `embalajes` VALUES (1,'saco 60kg',60.00,NULL,NULL),(2,'big bag',NULL,NULL,NULL),(4,'saco 70kg',70.00,NULL,NULL),(5,'saco 69kg',69.00,'2015-07-05 22:23:20','2015-07-05 22:23:20'),(6,'barril Jamaica',NULL,'2015-07-21 13:20:59','2015-07-21 13:20:59');
...
INSERT INTO `incoterms` VALUES (1,'CIF-Barcelona',NULL,'2015-07-21 13:15:34'),(2,'FOB',NULL,NULL),(3,'IN STORE',NULL,NULL),(4,'FOT ',NULL,NULL),(5,'IN STORE DESPACHADO',NULL,NULL),(6,'FOT DESPACHADO',NULL,NULL),(7,'CIF-Gijón','2015-07-21 13:16:03','2015-07-21 13:16:03');
...
CREATE TABLE `linea_contratos` (
  ...
  `embalaje_id` int(11) NOT NULL,
  `referencia` varchar(45) NOT NULL,
  `lotes_linea_contrato` mediumint(9) DEFAULT NULL,
...
INSERT INTO `linea_contratos` VALUES (12,22,15,2,'primer intento',NULL,'2015-07-17',220.00,210.00,NULL,'2015-07-17 21:27:27','2015-07-17 21:27:27'),(15,22,NULL,2,'BB',NULL,'2015-09-20',215.00,215.00,NULL,'2015-07-20 23:56:12','2015-07-20 23:56:12'),(19,31,NULL,1,'332211',5,'2015-07-01',220.00,225.00,NULL,'2015-07-21 20:23:31','2015-07-21 20:23:31'),(20,31,NULL,1,'12354-5654',1,'2015-07-01',220.00,210.00,NULL,'2015-07-21 21:22:35','2015-07-21 21:22:35');
...
INSERT INTO `operaciones` VALUES (12,'6666/66',33,NULL,'2015-06-25 16:51:23','2015-06-25 16:43:15'),(13,'999/99',44,0.000034,'2015-06-25 16:46:36','2015-06-25 16:46:36'),(14,'12345',200,1.325000,'2015-06-25 16:52:57','2015-06-25 16:52:57'),(15,'2014/123',1215,1.252000,NULL,NULL),(16,'2010/111',2000,1.120000,'2015-07-19 21:46:27','2015-07-19 21:46:27');
...
--
-- Temporary table structure for view `peso_linea_contratos`
--

DROP TABLE IF EXISTS `peso_linea_contratos`;
/*!50001 DROP VIEW IF EXISTS `peso_linea_contratos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `peso_linea_contratos` (
  `id` tinyint NOT NULL,
...
--
-- Temporary table structure for view `peso_linea_contratos2`
--

DROP TABLE IF EXISTS `peso_linea_contratos2`;
/*!50001 DROP VIEW IF EXISTS `peso_linea_contratos2`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `peso_linea_contratos2` (
  `linea_contrato_id` tinyint NOT NULL,
...
INSERT INTO `puertos` VALUES (1,'Venecia',9,'2015-06-15 13:05:17','2015-07-09 18:47:38'),(2,'Marsella',5,'2015-06-15 13:05:27','2015-06-15 13:05:27'),(3,'San Petesburgo',22,'2015-06-15 13:05:39','2015-06-15 13:05:39'),(5,'Burdeos',9,'2015-07-17 19:12:12','2015-07-17 19:12:12'),(6,'Barcelona',3,'2015-07-17 19:14:47','2015-07-17 19:14:47'),(7,'Bilbao',3,'2015-07-17 19:14:57','2015-07-17 19:15:02'),(8,'Santander',3,'2015-07-17 19:15:07','2015-07-17 19:15:21');
...
--
-- Final view structure for view `peso_linea_contratos`
--

/*!50001 DROP TABLE IF EXISTS `peso_linea_contratos`*/;
/*!50001 DROP VIEW IF EXISTS `peso_linea_contratos`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 VIEW `peso_linea_contratos` AS select `linea_contratos`.`id` AS `id`,`linea_contratos`.`contrato_id` AS `contrato_id`,(select ifnull(sum(`asociado_linea_contratos`.`cantidad_embalaje_asociado`),0) from `asociado_linea_contratos` where (`asociado_linea_contratos`.`linea_contrato_id` = `linea_contratos`.`id`)) AS `cantidad_embalaje`,((select ifnull(sum(`asociado_linea_contratos`.`cantidad_embalaje_asociado`),0) from `asociado_linea_contratos` where (`asociado_linea_contratos`.`linea_contrato_id` = `linea_contratos`.`id`)) * (select `contrato_embalajes`.`peso_embalaje_real` from `contrato_embalajes` where ((`contrato_embalajes`.`contrato_id` = `linea_contratos`.`contrato_id`) and (`contrato_embalajes`.`embalaje_id` = `linea_contratos`.`embalaje_id`)))) AS `peso` from `linea_contratos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `peso_linea_contratos2`
--

/*!50001 DROP TABLE IF EXISTS `peso_linea_contratos2`*/;
/*!50001 DROP VIEW IF EXISTS `peso_linea_contratos2`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cmpsa`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `peso_linea_contratos2` AS select `A`.`linea_contrato_id` AS `linea_contrato_id`,sum(`A`.`cantidad_embalaje_asociado`) AS `cantidad`,(sum(`A`.`cantidad_embalaje_asociado`) * `C`.`peso_embalaje_real`) AS `peso_total` from ((`asociado_linea_contratos` `A` join `linea_contratos` `B`) join `contrato_embalajes` `C`) where ((`A`.`linea_contrato_id` = `B`.`id`) and (`B`.`contrato_id` = `C`.`contrato_id`) and (`B`.`embalaje_id` = `C`.`embalaje_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cmpsa`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `resto_contratos` AS select `contratos`.`id` AS `id`,(`contratos`.`peso_comprado` - (select ifnull(sum(`peso_linea_contratos`.`peso`),0) from `peso_linea_contratos` where (`peso_linea_contratos`.`contrato_id` = `contratos`.`id`))) AS `peso_restante` from `contratos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cmpsa`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `resto_lotes_contratos` AS select `contratos`.`id` AS `id`,(`contratos`.`lotes_contrato` - (select ifnull(sum(`linea_contratos`.`lotes_linea_contrato`),0) from `linea_contratos` where (`linea_contratos`.`contrato_id` = `contratos`.`id`))) AS `lotes_restantes` from `contratos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-07-22 14:00:57
